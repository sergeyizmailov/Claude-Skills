...
- **Sheet-sourced catalog**: when the catalog is a Google Sheet scheduled feed (`17`), edit the sheet (`sheetfeed`) — the next fetch overwrites batch-API edits; new image = new URL (Meta caches by URL).
